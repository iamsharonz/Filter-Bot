...
from pyrogram import Client as sharonz
...
@sharonz.on_message(filters.command('id') & (filters.private | filters.group))
...
@sharonz.on_message(filters.command('info') & (filters.private | filters.group))
...
@sharonz.on_message((filters.private | filters.group) & filters.command('status'))
...
@sharonz.on_message(filters.command('start') & filters.private)
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Add Me To yoUR GroUp 😌", url="http://t.me/UnlimitedFilters_Bot?startgroup=true")
                ],
                [ 
                    InlineKeyboardButton("CreAtor", url="https://t.me/MrNobody_Here"),
...
@sharonz.on_message(filters.command('help') & filters.private)
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                 ...
                 [
                    InlineKeyboardButton("⬅️Back⬅️", callback_data="start_data")
                 ]
            ]
        ),
        reply_to_message_id=message.message_id
...
@sharonz.on_message(filters.command('about') & filters.private)
